...
export const projects: Project[] = [
  {
    ...
    content:
      "A full-stack application built with Next.js, TypeScript, and shadcn/ui components. Features include authentication, real-time updates, and responsive design.",
    status: "active",
  ...
  },
  {
    ...
    content:
      "Cross-platform mobile application for banking services with biometric authentication, real-time notifications, and advanced security features.",
    status: "active",
  ...
  },
  {
    ...
    content:
      "Comprehensive analytics platform providing insights into customer behavior, sales trends, and inventory management for e-commerce businesses.",
    status: "pending",
  ...
  },
  {
    ...
    content:
      "Automated deployment pipeline and infrastructure management tools to streamline development workflows and reduce deployment time.",
    status: "completed",
    category: "DevOps",
  ...
  },
  {
    ...
    content:
      "Machine learning application that generates high-quality content for marketing campaigns, blog posts, and social media.",
    status: "active",
  ...
  },
  {
    ...
    content:
      "Unified design system with reusable components, design tokens, and documentation to ensure consistency across all products.",
    status: "inactive",
    category: "Design",
...
export const projectCards: CardItem[] = projects.map(project => ({
  ...
  status: project.status as "active" | "pending" | "completed" | "inactive",
  image: project.image,
  actions: [
    {
      label: "View Details",

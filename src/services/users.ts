...
import { users, userSummaries, getUserById, getUserSummaryById } from '@/data/users'
...
export class UserService {
  ...
  async getUsers(params?: {
    ...
    // Real API call
    const response = await apiClient.get<UserSummary[]>('/users', params as Record<string, string>)
